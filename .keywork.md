...
2. **`dark` (Chế Độ Tối - High-Contrast Modern Dark Mode - ⭐ BAN ĐÊM)**:
   * Nền than xám `#0B0F19` / `#1E293B`, chữ trắng sáng sắc nét `#FFFFFF` và `#F8FAFC`.
   * Thẻ nhãn, bảng biểu và form nhập liệu được tăng cường độ tương phản cao, chống lóa và bảo vệ mắt ban đêm.
